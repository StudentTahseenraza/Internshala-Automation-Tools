...
function AutoApplyBot() {
  ...
  const handleAutoApply = async (e) => {
    ...
    if (!email.trim() || !password.trim() || !role.trim() || !userType) {
      setError(
        "Please provide email, password, role, and select user type (internship/job)."
      );
      return;
    }
    ...
    try {
      ...
      const errorMessage =
        ...
        "Failed to apply. Please try again. Timeout exceeded.";
  ...
  return (
    <div className="feature-page">
      ...
      <p>
        Applies to internships or jobs matching specified criteria, auto-fills
        forms.
      </p>
      ...
      {message && (
        <div className="result">
          ...
          {totalMatched > 0 && (
            <div>
              <p>
                Total {userType === "internship" ? "Internships" : "Jobs"}{" "}
